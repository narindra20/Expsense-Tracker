...
function IncomeList({ incomes = [], onDelete, onUpdate, isDarkMode }) {
              ...
              {editId === income.id ? (
                <>
                  ...
                  <td className="px-6 py-4 flex gap-2">
                    <button onClick={() => handleSave(income.id)} className="bg-green-500 text-white px-3 py-1 rounded">
                      Sauvegarder
                    </button>
                ...
                <>
                  ...
                  <td className="px-6 py-4 flex gap-2">
                    <button onClick={() => { setEditId(income.id); setEditData(income); }} className="text-blue-600 hover:text-blue-900">
                      Modifier
                    </button>
